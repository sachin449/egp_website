                ...
                <div className="flex-1 bg-gray-800 bg-opacity-80 rounded-lg p-8 lg:ml-8">
                    ...
                    <form className="space-y-6">
                        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                            <input type="text" className="w-full sm:w-1/2 p-4 rounded-md bg-gray-700 bg-opacity-80 text-white" placeholder="Enter your name" required />
                            <input type="email" className="w-full sm:w-1/2 p-4 rounded-md bg-gray-700 bg-opacity-80 text-white" placeholder="Enter your email" required />
                        </div>
